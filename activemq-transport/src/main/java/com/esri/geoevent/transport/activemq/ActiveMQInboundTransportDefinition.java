...
public class ActiveMQInboundTransportDefinition extends TransportDefinitionBase {
  ...
  public ActiveMQInboundTransportDefinition() {
    ...
    try {
      ...
      /*propertyDefinitions.put("artemisTSPath", new PropertyDefinition("ARTEMIS_TS_PATH", PropertyType.String, null, "${com.esri.geoevent.transport.activemq-transport.TRANSPORT_IN_ARTEMIS_TS_PATH_LBL}", "${com.esri.geoevent.transport.activemq-transport.TRANSPORT_IN_ARTEMIS_TS_PATH_DESC}", true, false));
      propertyDefinitions.put("artemisKSPath", new PropertyDefinition("ARTEMIS_KS_PATH", PropertyType.String, null, "${com.esri.geoevent.transport.activemq-transport.TRANSPORT_IN_ARTEMIS_KS_PATH_LBL}", "${com.esri.geoevent.transport.activemq-transport.TRANSPORT_IN_ARTEMIS_KS_PATH_DESC}", true, false));
      propertyDefinitions.put("artemisTSPasswd", new PropertyDefinition("ARTEMIS_TS_PASSWD", PropertyType.String, null, "${com.esri.geoevent.transport.activemq-transport.TRANSPORT_IN_ARTEMIS_TS_PASSWD_LBL}", "${com.esri.geoevent.transport.activemq-transport.TRANSPORT_IN_ARTEMIS_TS_PASSWD_DESC}", true, false));
      propertyDefinitions.put("artemisKSPasswd", new PropertyDefinition("ARTEMIS_KS_PASSWD", PropertyType.String, null, "${com.esri.geoevent.transport.activemq-transport.TRANSPORT_IN_ARTEMIS_KS_PASSWD_LBL}", "${com.esri.geoevent.transport.activemq-transport.TRANSPORT_IN_ARTEMIS_KS_PASSWD_DESC}", true, false));*/
      propertyDefinitions.put("artemisTSPath", new PropertyDefinition("artemisTSPath", PropertyType.String, null, "${com.esri.geoevent.transport.activemq-transport.TRANSPORT_IN_ARTEMIS_TS_PATH_LBL}", "${com.esri.geoevent.transport.activemq-transport.TRANSPORT_IN_ARTEMIS_TS_PATH_DESC}", true, false));
      propertyDefinitions.put("artemisKSPath", new PropertyDefinition("artemisKSPath", PropertyType.String, null, "${com.esri.geoevent.transport.activemq-transport.TRANSPORT_IN_ARTEMIS_KS_PATH_LBL}", "${com.esri.geoevent.transport.activemq-transport.TRANSPORT_IN_ARTEMIS_KS_PATH_DESC}", true, false));
      propertyDefinitions.put("artemisTSPasswd", new PropertyDefinition("artemisTSPasswd", PropertyType.String, null, "${com.esri.geoevent.transport.activemq-transport.TRANSPORT_IN_ARTEMIS_TS_PASSWD_LBL}", "${com.esri.geoevent.transport.activemq-transport.TRANSPORT_IN_ARTEMIS_TS_PASSWD_DESC}", true, false));
      propertyDefinitions.put("artemisKSPasswd", new PropertyDefinition("artemisKSPasswd", PropertyType.String, null, "${com.esri.geoevent.transport.activemq-transport.TRANSPORT_IN_ARTEMIS_KS_PASSWD_LBL}", "${com.esri.geoevent.transport.activemq-transport.TRANSPORT_IN_ARTEMIS_KS_PASSWD_DESC}", true, false));
