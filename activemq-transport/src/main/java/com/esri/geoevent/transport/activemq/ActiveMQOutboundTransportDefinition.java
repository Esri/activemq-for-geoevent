...
{
  final static private Log LOG = LogFactory.getLog(ActiveMQOutboundTransportDefinition.class);
  ...
  public ActiveMQOutboundTransportDefinition()
  {
    ...
    {
      LOG.error("Failed to define properties of ActiveMQOutboundTransportDefinition: ", e);
  ...
  {
    return "ActiveMQ Outbound Transport";
  }
  ...
  {
    return "Esri JMS Outbound Transport for connecting to ActiveMQ message servers.";
  }
}
